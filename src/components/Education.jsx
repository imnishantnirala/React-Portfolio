...
const Card = ({ data }) => (
  <figure className={`h-[350px] w-[500px] flex flex-col items-start justify-start p-8 text-center bg-white dark:bg-gray-900 rounded-xl shadow-xl border-2 border-blue-950 mb-10 ${data.position === 'left' ? 'left-card' : 'right-card'}`}>
...
const Education = () => (
  <div className='container mx-auto pt-11' id='Education'>
    <h1 className='text-center text-[35px] font-bold text-white'> Education </h1>
    <p className='text-center text-[20px] text-gray-400'> My education has been a journey of self-discovery and growth. My educational details are as follows. </p>
